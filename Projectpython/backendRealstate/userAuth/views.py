...
from .serializer import RoleSerializer, TemoinageSerializer, BlogSerializer, ContactSerializer, RegisterSerializer, \
    RdvSerializer, PropertySerializer, ImageSerializer, ServiceSerializer, CategorySerializer
from .models import User, Temoinage, Blog, Contact, RDV, Image, Property, Service, Category
